...
import DialogConectUsForm from "./components/dialog-connect-from";
...
function App() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      name: "Sneha Reddy",
      role: "E-commerce Owner, Hyderabad",
      initial: "S",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 pt-32 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left ml-md-[6.5rem] ml-[0px]">
              <div className="mb-2">
                <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-3">
                  <span className="text-transparent bg-clip-text bg-[#E65454]">
                    {" "}
                    Your All-In-One Branding & Promotion App
                  </span>
                </h1>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Trusted Nationwide by 5,000+ Businesses
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                {/* <button className="bg-[#E65454] text-white px-8 py-4 rounded-lg font-semibold text-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                  Get Started
                </button> */}
                <button
                  onClick={() => {
                  ...
                  className="bg-[#E65454] text-white px-8 py-4 rounded-lg font-semibold text-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105"
                >
                  Get Started
                </button>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#E65454] rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-20 px-sm-20 px-4 bg-gray-50" id="features">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg transition-all duration-500 transform hover:scale-105 hover:text-white">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              <div className="w-16 h-16 bg-gradient-to-r bg-purple-500 rounded-2xl flex items-center justify-center mb-6">
      ...
      <section id="how-it-works" className="py-20 px-md-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              How It Works
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-[#E65454] rounded-full flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold">
                1
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">
                Sign up & onboard
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-red-500  to-red-400 text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8">
              <div className="w-16 h-16 bg-teal-400 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <Bot className="text-white" size={32} />
              </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="text-center">
                <h3 className="text-5xl font-bold text-transparent bg-clip-text bg-[#E65454] mb-2">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-red-400  to-red-500 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <button className="bg-white text-red-600 px-8 py-4 rounded-lg font-semibold text-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                Subscribe Now
              </button>
            </div>
            <div className="relative">
              <div className="bg-white/20 backdrop-blur-lg rounded-2xl p-8 shadow-2xl">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 text-center">
                  ...
                  <div className="bg-gradient-to-r from-red-400 to-red-500 h-2 rounded-full"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border hover:scale-105 transition-transform">
              ...
              <p className="text-4xl font-bold text-transparent bg-clip-text bg-[#E65454] mb-6">
                ₹499{" "}
                <span className="text-lg font-medium text-gray-600">/mo</span>
              </p>
              <ul className="text-gray-600 space-y-3 mb-6">
                <li className="flex gap-3 justify-center">
                  <Check color={"#E65454"} /> Digital Profile
                </li>
                <li className="flex gap-3 justify-center">
                  <Check color={"#E65454"} /> NFC Business Card
                </li>
                <li className="flex gap-3 justify-center">
                  <Check color={"#E65454"} /> Limited Graphics
                </li>
                <li className="flex gap-3 justify-center">
            ...
            {/* Standard Plan */}
            <div className="bg-white rounded-2xl shadow-2xl p-8 scale-105 border-4 border-red-500">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex gap-3 justify-center">
                  <Check color={"#E65454"} /> Everything in Basic
                </li>
                <li className="flex gap-3 justify-center">
                  <Check color={"#E65454"} /> Festival Graphics
                </li>
                <li className="flex gap-3 justify-center">
                  <Check color={"#E65454"} /> Chatbot Automation
                </li>
                <li className="flex gap-3 justify-center">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border hover:scale-105 transition-transform">
              ...
              <ul className="text-gray-600 space-y-3 mb-6">
                <li className="flex gap-3 justify-center">
                  <Check color={"#E65454"} /> Everything in Standard
                </li>
                <li className="flex gap-3 justify-center">
                  <Check color={"#E65454"} /> Advanced Analytics
                </li>
                <li className="flex gap-3 justify-center">
                  <Check color={"#E65454"} /> Priority Support
                </li>
                <li className="flex gap-3 justify-center">
                  <Check color={"#E65454"} /> Unlimited Campaigns
                </li>
              </ul>
              <button
